...
('meta-updater',              15, 'https://github.com/uptane/meta-updater.git',             'branch=master,commit=c2b18de', ''),
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=kirkstone,commit=590065c', ''),
