...
('meta-webos',                40, 'git://github.com/shr-project/meta-webosose.git',         'branch=zeus,commit=zeus-2020-01-26b', ''),
...
('meta-security',             77, 'git://git.yoctoproject.org/meta-security',               'branch=zeus,commit=42a1ac5', ''),
]
