...
webos_layers = [
('bitbake',                   -1, 'https://github.com/openembedded/bitbake.git',            'branch=2.4,commit=8d153f1da', ''),

('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=mickledore,commit=23b5141400', 'oe-core'),

('meta-oe',                   10, 'https://github.com/openembedded/meta-openembedded.git',  'branch=mickledore,commit=8e1f0fa6bf', 'meta-oe'),
...
('meta-clang',                15, 'https://github.com/kraj/meta-clang.git',                 'branch=mickledore,commit=8bceec8', ''),
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=mickledore,commit=b8db7002', ''),

('meta-qt6',                  20, 'https://code.qt.io/yocto/meta-qt6.git',                  'branch=6.8.0,commit=d6e576a', ''),
...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=mickledore,commit=mickledore-2024-11-05', ''),

('meta-raspberrypi',          50, 'https://github.com/agherzan/meta-raspberrypi.git',       'branch=mickledore,commit=7a21646', ''),
...
('meta-security',             76, 'https://git.yoctoproject.org/git/meta-security',         'branch=mickledore,commit=d7db0a3', ''),
]
