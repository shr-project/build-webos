...
('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=dunfell,commit=44b1970c40', 'oe-core'),
...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=dunfell,commit=dunfell-2021-11-26', ''),
