...
webos_layers = [
('bitbake',                   -1, 'git://github.com/openembedded/bitbake.git',              'branch=1.42,commit=aa770081', ''),

('meta',                       5, 'git://github.com/openembedded/openembedded-core.git',    'branch=warrior,commit=a63d59f64a', 'oe-core'),
