...
('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=kirkstone,commit=555fd2848b', 'oe-core'),
...
('meta-updater',              15, 'https://github.com/uptane/meta-updater.git',             'branch=kirkstone,commit=c74a067', ''),
