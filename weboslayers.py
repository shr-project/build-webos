...
webos_layers = [
('bitbake',                   -1, 'git://github.com/openembedded/bitbake.git',              'branch=master,commit=9345d257', ''),

('meta',                       5, 'git://github.com/openembedded/openembedded-core.git',    'branch=master,commit=1f26495884', 'oe-core'),
...
('meta-webos',                40, 'git://github.com/shr-project/meta-webosose.git',         'branch=master,commit=master-2020-10-20', ''),
...
('meta-security',             77, 'git://git.yoctoproject.org/meta-security',               'branch=master,commit=e8c9e69', ''),
]
