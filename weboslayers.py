...
webos_layers = [
('bitbake',                   -1, 'https://github.com/openembedded/bitbake.git',            'branch=1.46,commit=3b719e8e', ''),

('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=dunfell,commit=a3cba15142', 'oe-core'),

('meta-oe',                   10, 'https://github.com/openembedded/meta-openembedded.git',  'branch=dunfell,commit=f22bf6efaa', 'meta-oe'),
...
('meta-updater',              15, 'https://github.com/uptane/meta-updater.git',             'branch=dunfell,commit=8e02177', ''),
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=dunfell,commit=a63a54d', ''),
...
('meta-webos-backports-3.3',  34, 'https://github.com/shr-project/meta-webosose.git',       '', ''),
...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=dunfell,commit=dunfell-2022-09-01', ''),
