...
('meta-oe',                   10, 'git://github.com/openembedded/meta-openembedded.git',    'branch=honister,commit=41e4341061', 'meta-oe'),
...
('meta-virtualization',       16, 'git://git.yoctoproject.org/meta-virtualization',         'branch=honister,commit=816dd55', ''),
...
('meta-webos',                40, 'git://github.com/shr-project/meta-webosose.git',         'branch=honister,commit=honister-2021-10-12', ''),

('meta-raspberrypi',          50, 'git://git.yoctoproject.org/meta-raspberrypi',            'branch=master,commit=9eb4879', ''),
...
('meta-security',             77, 'git://git.yoctoproject.org/meta-security',               'branch=master,commit=a85fbe9', ''),
]
