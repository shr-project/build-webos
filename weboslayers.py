...
('meta-updater',              15, 'git://github.com/advancedtelematic/meta-updater.git',    'branch=thud,commit=64bf6f0', ''),
...
('meta-webos',                40, 'git://github.com/shr-project/meta-webosose.git'          'branch=thud,commit=thud-2020-02-24', ''),
