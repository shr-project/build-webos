...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=walnascar,commit=walnascar-2025-08-22', ''),

('meta-raspberrypi',          50, 'https://github.com/agherzan/meta-raspberrypi.git',       'branch=walnascar,commit=1ff318c32b3', ''),
