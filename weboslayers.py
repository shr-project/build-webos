...
('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=scarthgap,commit=2f242f2a269', 'oe-core'),
...
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=scarthgap,commit=52cf1d59c5a', ''),
...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=scarthgap,commit=scarthgap-2025-04-02', ''),
