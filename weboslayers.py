...
webos_layers = [
('bitbake',                   -1, 'git://github.com/openembedded/bitbake.git',              'branch=master,commit=765be5ef', ''),

('meta',                       5, 'git://github.com/openembedded/openembedded-core.git',    'branch=master,commit=6e16ef0c2e', 'oe-core'),
...
('meta-virtualization',       16, 'git://git.yoctoproject.org/meta-virtualization',         'branch=master,commit=3bfea24', ''),
...
('meta-webos',                40, 'git://github.com/shr-project/meta-webosose.git',         'branch=master,commit=master-2020-07-08b', ''),

('meta-raspberrypi',          50, 'git://git.yoctoproject.org/meta-raspberrypi',            'branch=master,commit=27d0016', ''),
