...
('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=mickledore,commit=a24b257189', 'oe-core'),

('meta-oe',                   10, 'https://github.com/openembedded/meta-openembedded.git',  'branch=mickledore,commit=5a01ab461c', 'meta-oe'),
...
('meta-clang',                15, 'https://github.com/kraj/meta-clang.git',                 'branch=mickledore,commit=788bae2', ''),
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=mickledore,commit=d0c3d1b', ''),
...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=mickledore,commit=mickledore-2023-06-21', ''),
