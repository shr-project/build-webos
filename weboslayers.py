...
('meta',                       5, 'git://github.com/openembedded/openembedded-core.git',    'branch=master,commit=5fdc061856', 'oe-core'),

('meta-oe',                   10, 'git://github.com/openembedded/meta-openembedded.git',    'branch=master,commit=ab28d08793', 'meta-oe'),
...
('meta-virtualization',       16, 'git://git.yoctoproject.org/meta-virtualization',         'branch=master,commit=daac3b6', ''),
...
('meta-security',             77, 'git://git.yoctoproject.org/meta-security',               'branch=master,commit=46f7e7a', ''),
]
