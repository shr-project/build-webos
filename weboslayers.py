...
('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=master,commit=bbcd56bace', 'oe-core'),

('meta-oe',                   10, 'https://github.com/openembedded/meta-openembedded.git',  'branch=master,commit=62b0d59023', 'meta-oe'),
...
('meta-clang',                15, 'https://github.com/kraj/meta-clang.git',                 'branch=master,commit=0b2616e', ''),
...
('meta-raspberrypi',          50, 'https://github.com/agherzan/meta-raspberrypi.git',       'branch=master,commit=3d6873d', ''),
...
('meta-security',             76, 'https://git.yoctoproject.org/git/meta-security',         'branch=master,commit=db91051', ''),
]
