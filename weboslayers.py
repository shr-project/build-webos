...
('meta',                       5, 'git://github.com/openembedded/openembedded-core.git',    'branch=zeus,commit=0743dcd0cd', 'oe-core'),
...
('meta-updater',              15, 'git://github.com/advancedtelematic/meta-updater.git',    'branch=zeus,commit=8997893', ''),
