...
('meta-updater',              15, 'https://github.com/uptane/meta-updater.git',             'branch=master,commit=63fee1a', ''),
...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=master,commit=mickledore-2023-04-26', ''),
...
('meta-security',             77, 'https://git.yoctoproject.org/git/meta-security',         'branch=mickledore,commit=9d819c1', ''),
]
