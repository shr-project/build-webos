...
('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=master,commit=6623965331', 'oe-core'),
...
('meta-clang',                15, 'https://github.com/kraj/meta-clang.git',                 'branch=master,commit=f53a67a', ''),
