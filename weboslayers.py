...
('meta',                       5, 'git://github.com/openembedded/openembedded-core.git',    'branch=zeus,commit=2bba005259', 'oe-core'),
...
('meta-webos',                40, 'git://github.com/shr-project/meta-webosose.git',         'branch=zeus,commit=zeus-2020-01-28', ''),
