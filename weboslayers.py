...
('meta-clang',                15, 'https://github.com/kraj/meta-clang.git',                 'branch=walnascar,commit=d1e5cbbe185', ''),
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=walnascar,commit=88698b34937', ''),

('meta-qt6',                  20, 'https://code.qt.io/yocto/meta-qt6.git',                  'branch=6.8.1,commit=f4ef1331f0c', ''),

('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=walnascar,commit=walnascar-2025-04-11', ''),
