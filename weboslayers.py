...
webos_layers = [
('bitbake',                   -1, 'https://github.com/openembedded/bitbake.git',            'branch=2.4,commit=d97d62e2', ''),

('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=mickledore,commit=ab232138f6', 'oe-core'),

('meta-oe',                   10, 'https://github.com/openembedded/meta-openembedded.git',  'branch=mickledore,commit=c032fd0b1a', 'meta-oe'),
...
('meta-clang',                15, 'https://github.com/kraj/meta-clang.git',                 'branch=mickledore,commit=0d54bee', ''),
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=mickledore,commit=1e338cb', ''),
...
('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=mickledore,commit=mickledore-2023-04-27', ''),

('meta-raspberrypi',          50, 'https://github.com/agherzan/meta-raspberrypi.git',       'branch=mickledore,commit=928bb23', ''),
