...
webos_layers = [
('bitbake',                   -1, 'https://github.com/openembedded/bitbake.git',            'branch=master,commit=b171aa45', ''),

('meta',                       5, 'https://github.com/openembedded/openembedded-core.git',  'branch=master,commit=b4f1b78aef', 'oe-core'),

('meta-oe',                   10, 'https://github.com/openembedded/meta-openembedded.git',  'branch=master,commit=0c2e416567', 'meta-oe'),
...
('meta-virtualization',       16, 'https://git.yoctoproject.org/git/meta-virtualization',   'branch=master,commit=7ec4b47', ''),

('meta-qt6',                  20, 'https://code.qt.io/yocto/meta-qt6.git',                  'branch=6.3.0,commit=f7c9337', ''),

('meta-webos',                40, 'https://github.com/shr-project/meta-webosose.git',       'branch=master,commit=master-2022-07-19', ''),

('meta-raspberrypi',          50, 'https://github.com/agherzan/meta-raspberrypi.git',       'branch=master,commit=62a8483', ''),
...
('meta-security',             77, 'https://git.yoctoproject.org/git/meta-security',         'branch=master,commit=7ad5f6a', ''),
]
