...
webos_layers = [
('bitbake',                   -1, 'git://github.com/openembedded/bitbake.git',              'branch=1.52,commit=032190aa', ''),

('meta',                       5, 'git://github.com/openembedded/openembedded-core.git',    'branch=honister,commit=907ebb5bb3', 'oe-core'),

('meta-oe',                   10, 'git://github.com/openembedded/meta-openembedded.git',    'branch=master,commit=aee2f10638', 'meta-oe'),
...
('meta-webos',                40, 'git://github.com/shr-project/meta-webosose.git',         'branch=honister,commit=honister-2021-09-24', ''),

('meta-raspberrypi',          50, 'git://git.yoctoproject.org/meta-raspberrypi',            'branch=master,commit=5f72ec0', ''),
...
('meta-security',             77, 'git://git.yoctoproject.org/meta-security',               'branch=master,commit=de6712a', ''),
]
